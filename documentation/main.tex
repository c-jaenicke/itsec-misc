...
TODO: alle netzwerkausschnitte betrachten, unten ist nur von normal.pcapng

\begin{table}[h]
\centering
\begin{tabular}{|l|l|l|}
\hline
\textbf{MAC-Adresse} & \textbf{Name} & \textbf{IP-Adresse} \\
\hline
00:1b:1b:f7:7c:4f & Siemens\_f7:7c:4f & 10.3.5.5 \\
00:26:5a:e7:b7:c4 & DLink\_e7:b7:c4 & 10.3.5.1 \\
01:00:5e:00:00:fc & IPv4mcast\_fc & 224.0.0.252 \\
01:00:5e:7f:ff:64 & IPv4mcast\_7f:ff:64 & 239.255.255.100 \\
01:00:5e:7f:ff:fa & IPv4mcast\_7f:ff:fa & 239.255.255.250 \\
01:80:c2:00:00:0e & LLDP\_Multicast & - \\
28:63:36:ad:91:96 & Siemens\_ad:91:96 & 10.3.5.12 \\
28:63:36:ad:91:97 & Siemens\_ad:91:97 & - \\
28:63:36:ae:70:0b & Siemens\_ae:70:0b & - \\
f4:8e:38:9f:7c:74 & Dell\_9f:7c:74 & 10.3.5.3 \\
\hline
\end{tabular}
\caption{Netzwerkteilnehmer (normal.pcapng)}
\label{tab:network_participants_normal}
\end{table}
...
\hline
\textbf{MAC-Adresse} & \textbf{Gerät-Typ} & \textbf{Model/Details} & \textbf{IP-Adresse} \\
\hline
00:1b:1b:f7:7c:4f & SIEMENS AG SIMATIC & Field PG M5 & 10.3.5.5 \\
\hline
28:63:36:ad:91:97 & Siemens SIMATIC S7 & CPU1511-1 PN & - \\
\hline
28:63:36:ae:70:0b & Siemens SIMATIC S7 & CPU1512C-1 PN & - \\
\hline
f4:8e:38:9f:7c:74 & Dell OptiPlex & 3046 & 10.3.5.3 \\
\hline
\end{tabular}
\caption{LLDP Geräteinformationen}
\label{tab:lldp_info}
\end{table}
...
\hline
\end{tabular}
\caption{Verwendete Protokolle}
\label{tab:protokolle}
\end{table}
...
\begin{figure}[H]
    ...
    \label{fig:suspicious_traffic}
\end{figure}

\textbf{Wann hat der Rechner sich versucht mit einem Host außerhalb des Netzwerks zu verbinden?}

Der erste Verbindungsversuch zu einem externen Host wurde am 8. Juni 2018 um 13:46:47.788372000 CEST registriert. Dies war ein UDP-Paket (Frame 96 in der Aufzeichnung).
...
In diesem Mitschnitt ist das Address Resolution Protocol (ARP) auffällig dominant. Es macht 53,7\% aller Pakete aus, was auf einen intensiven Netzwerk-Scan hindeutet. TODO: Zusätzlich sind zahlreiche Verbindungsversuche zu verschiedenen Ports zu beobachten.
...
Das SIEMENS AG SIMATIC Field PG M5 des Technikers (10.3.5.5, MAC: 00:1b:1b:f7:7c:4f) führt den Netzwerk-Scan durch. Dies bestätigt den Verdacht aus Phase 1, dass dieses System kompromittiert wurde.
...
\begin{figure}[H]
    ...
    \label{fig:port_102_connections}
\end{figure}
...
In dieser Phase wird das Virtual Network Computing (VNC) Protokoll neu eingesetzt. Dies deutet auf Versuche hin, Fernzugriff auf andere Systeme zu erlangen.

\textbf{Wurde die Verbindung erfolgreich hergestellt? Notieren Sie ggf. den Zeitstempel.}

Eine TCP-Verbindung wurde erfolgreich hergestellt. Der Zeitablauf war wie folgt:
\begin{itemize}
    \item SYN-Paket gesendet: 8. Juni 2018, 14:13:36.774417000 CEST
    \item Letztes Paket der TCP-Verbindung: 8. Juni 2018, 14:13:37.181877000 CEST
\end{itemize}
