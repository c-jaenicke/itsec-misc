...
Für detaillierte Informationen zur Konfiguration der Firewall und des Webservers siehe Anhang \ref{firewall-info} und \ref{webserver-info}.
\\ \\
...
Im Folgenden wird ein SQL-Injection-Angriff auf den Webserver beschrieben.
\\ \\
...
Im Folgenden wird die Durchführung eines Cross-Site-Scripting-Angriffs beschrieben.
\\ \\
...
Als aufwändigere Methode gibt es auch die Möglichkeit der Cold-Boot-Attacke oder des Cold Storage:
\\ \\
